...
function pathIncludes(path, element) {
  return (path.includes(element.name) || path.endsWith(element.name));
}
 ...
 */
async function addDependenciesRecursive(depsIndex, projectRootPath, exclusions, inclusions, rootPath, fields) {
