...
/**
 * Remove duplicate entries from the list of dependencies; the
 * list is sorted by package name before removing the duplicates.
 * @param {Array<object>} dependenciesList - list of dependencies
 * @returns {Array<object>} sorted and deduped list of dependencies
 */
const dedupeDependenciesList = (dependenciesList) => {
  const sortedList = dependenciesList.sort(alphaSort);
